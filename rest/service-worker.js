import { config } from "./package_9ae5bd376c973aa197898efca381dd451229cdff/uno-config.js";
...
if (config.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('package_9ae5bd376c973aa197898efca381dd451229cdff').then(async function (cache) {
